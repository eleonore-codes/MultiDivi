import {LEVEL_NAMES} from './config.js';
...
export async function createCard(card){
  ...
  c.font='40px Arial';c.fillText('Stark geübt!',75,310);
  ...
  c.fillStyle='#142e41';c.font='36px Arial';c.fillText((card.phase==='a'?'3-Minuten-Training':'2-Minuten-Fokustraining'),75,980);
  c.font='30px Arial';c.fillText('Level '+card.level+' · '+LEVEL_NAMES[card.level],75,1035);
